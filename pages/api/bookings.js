...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Enviar correo (si falla no bloquea la reserva)
    try {
          ...
          <div style="font-family:sans-serif;max-width:480px;margin:0 auto;">
            ...
            <div style="border:1px solid #e5e7eb;border-top:none;border-radius:0 0 12px 12px;padding:24px;">
              <table style="width:100%;border-collapse:collapse;font-size:15px;">
                <tr><td style="padding:8px 0;color:#6b7280;width:110px;">Profesional</td><td style="font-weight:600;">${profesional || '—'}</td></tr>
                <tr><td style="padding:8px 0;color:#6b7280;">Servicio</td><td style="font-weight:600;">${servicio || '—'}</td></tr>
                <tr><td style="padding:8px 0;color:#6b7280;">Precio</td><td style="font-weight:600;">$${Number(precio||0).toLocaleString('es-CL')}</td></tr>
